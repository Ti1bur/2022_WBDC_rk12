...
def parse_args():
    ...
    parser.add_argument('--val_ratio', default=0.0, type=float, help='split 10 percentages of training data as validation')
    ...
    parser.add_argument('--test_batch_size', default=80, type=int, help="use for testing duration per worker")
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--ckpt_file', type=str, default='save/fold3/1/model.bin')
    ...
    parser.add_argument('--max_steps', default=25000, type=int, metavar='N', help='number of total epochs to run')
    ...
    parser.add_argument('--learning_rate', default=6e-5, type=float, help='initial learning rate')
    parser.add_argument('--bert_learning_rate', default=6e-5, type=float, help='initial learning rate')
