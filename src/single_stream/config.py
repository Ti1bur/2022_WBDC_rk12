...
def parse_args():
    parser = argparse.ArgumentParser(description="Final Code for Weixin Challenge 2022")
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--ckpt_file', type=str, default='./save/vit-14-pretrain30-ema-pgd3-origin-dataset/single_model.bin')
    ...
    parser.add_argument('--savedmodel_path', type=str, default='./save/vit-14-pretrain30-ema-pgd3-origin-dataset')
